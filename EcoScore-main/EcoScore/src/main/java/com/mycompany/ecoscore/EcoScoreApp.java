...
public class EcoScoreApp extends javax.swing.JFrame {
    ...
    // boolean to track if button is selected
    private boolean electricRadioSelected = false;
    private boolean gasRadioSelected = false;
    private boolean oilRadioSelected = false;
    private boolean newspaperSelected = false;
    private boolean tinSelected = false;
    ...
    private void initComponents() {
        ...
        titleText22 = new javax.swing.JLabel();
        ...
        titleText18.setText("Your annual carbon footprint is");
        ...
        txtResults.setBackground(new java.awt.Color(150, 194, 43));
        txtResults.setFont(new java.awt.Font("Bangla Sangam MN", 1, 36)); // NOI18N
        ...
        titleText22.setFont(new java.awt.Font("Bangla Sangam MN", 1, 36)); // NOI18N
        titleText22.setText("lbs.");
        ...
        jPanel10Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel10Layout.createSequentialGroup()
                .addGap(16, 16, 16)
                .addComponent(titleText18, javax.swing.GroupLayout.PREFERRED_SIZE, 480, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addComponent(txtResults, javax.swing.GroupLayout.PREFERRED_SIZE, 205, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addComponent(titleText22)
    ...
    private void btnNextToTab9ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnNextToTab9ActionPerformed
        ...
        if (!newspaperSelected) {
            JOptionPane.showMessageDialog(this, "Please select an option before proceeding.", "Error", JOptionPane.ERROR_MESSAGE);
            return; // stops further execution if a radio button is not selected
        }
    ...
    private void btnNextToTab8ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnNextToTab8ActionPerformed
        ...
        String inputLongFlights = inputNumLongFlights.getText().trim();

        if (inputLongFlights.isEmpty()) {
            // displays an error message for empty input
            JOptionPane.showMessageDialog(this, "Please enter the yearly mileage.", "Error", JOptionPane.ERROR_MESSAGE);
            return;
        }

        try {
            int numLongFlights = Integer.parseInt(inputLongFlights);
            user.setSmallFlights(numLongFlights);
            jTabbedPane1.setSelectedIndex(7);
        } catch (NumberFormatException e) {
            // displays an error message for invalid input
            JOptionPane.showMessageDialog(this, "Please enter a valid integer value for the number of flights.", "Error", JOptionPane.ERROR_MESSAGE);
        }
    ...
    private void btnNextToTab7ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnNextToTab7ActionPerformed
        ...
        String inputShortFlights = inputNumShortFlights.getText().trim();

        if (inputShortFlights.isEmpty()) {
            // displays an error message for empty input
            JOptionPane.showMessageDialog(this, "Please enter the yearly mileage.", "Error", JOptionPane.ERROR_MESSAGE);
            return;
        }
        ...
        try {
            int numShortFlights = Integer.parseInt(inputShortFlights);
            user.setSmallFlights(numShortFlights);
    ...
    private void btnNextToTab6ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnNextToTab6ActionPerformed
        // TODO add your handling code here:
        String mileageInput = inputMileage.getText().trim();
        ...
        try {
            ...
            // displays an error message for invalid input
            JOptionPane.showMessageDialog(this, "Please enter a valid integer value for mileage.", "Error", JOptionPane.ERROR_MESSAGE);
        }
    ...
    private javax.swing.JLabel titleText22;
